...
public class TemporalMuteHudOverlay {

    private static final long DURATION_MS = 6000; // Matches MUTE_DURATION_MS
    ...
    public static void register() {
        HudElementRegistry.attachElementAfter(
                ...
                Identifier.fromNamespaceAndPath("rituals", "temporal_mute_hud"),
                new HudElement() {
                    @Override
