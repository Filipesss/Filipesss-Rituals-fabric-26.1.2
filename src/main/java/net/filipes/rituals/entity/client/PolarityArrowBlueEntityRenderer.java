...
public class PolarityArrowBlueEntityRenderer extends ArrowRenderer<PolarityArrowBlueEntity, PolarityArrowRenderState> {

    private static final Identifier TEXTURE =
            Identifier.fromNamespaceAndPath("rituals",
                    "textures/entity/projectiles/polarity_arrow_blue.png");

    public PolarityArrowBlueEntityRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(PolarityArrowBlueEntity entity, PolarityArrowRenderState state, float partialTick) {
        ...
        for (int i = 0; i < size; i++) {
            int idx = Math.floorMod(entity.trailHead - 1 - i, PolarityArrowBlueEntity.TRAIL_LENGTH);
    ...
    private static void drawTrail(PolarityArrowRenderState state, PoseStack ps, SubmitNodeCollector snc) {
        ...
        for (int i = 0; i < totalSegs; i++) {
            ...
            // Note: Currently uses RGB (20, 210, 165) which produces a nice teal/cyan trail.
