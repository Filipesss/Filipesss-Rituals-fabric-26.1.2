...
public class CinderArrowEntityRenderer extends ArrowRenderer<CinderArrowEntity, CinderArrowRenderState> {

    private static final Identifier TEXTURE =
            Identifier.fromNamespaceAndPath("rituals",
                    "textures/entity/projectiles/cinder_arrow.png");

    public CinderArrowEntityRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public CinderArrowRenderState createRenderState() {
        return new CinderArrowRenderState();
    }

    @Override
    public void extractRenderState(CinderArrowEntity entity, CinderArrowRenderState state, float partialTick) {
    ...
    @Override
    public void submit(CinderArrowRenderState state, PoseStack matrices,
    ...
    @Override
    public Identifier getTextureLocation(CinderArrowRenderState state) {
        return TEXTURE;
    }

    private static void drawTrail(CinderArrowRenderState state, PoseStack ps, SubmitNodeCollector snc) {
