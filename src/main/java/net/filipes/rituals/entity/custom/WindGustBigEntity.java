...
public class WindGustBigEntity extends Entity implements Scalable {

    public static final int   FRAME_COUNT = 12;
    public static final float QUAD_SIZE   = 2.0f;

    private static final EntityDataAccessor<Float> DATA_SCALE =
            SynchedEntityData.defineId(WindGustBigEntity.class, EntityDataSerializers.FLOAT);

    public WindGustBigEntity(EntityType<? extends WindGustBigEntity> type, Level level) {
        super(type, level);
        this.noPhysics = true;
    }
