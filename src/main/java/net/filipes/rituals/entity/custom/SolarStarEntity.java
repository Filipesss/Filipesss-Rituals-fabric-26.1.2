...
public class SolarStarEntity extends Entity {

    private static final EntityDataAccessor<Integer> OWNER_ID =
            SynchedEntityData.defineId(SolarStarEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Float> FLARE =
            SynchedEntityData.defineId(SolarStarEntity.class, EntityDataSerializers.FLOAT);
