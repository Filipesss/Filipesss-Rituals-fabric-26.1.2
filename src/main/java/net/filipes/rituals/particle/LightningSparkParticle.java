...
public class LightningSparkParticle extends SingleQuadParticle {
    ...
    protected LightningSparkParticle(ClientLevel level, double x, double y, double z,
        ...
        this.quadSize   = 0.6f;   // smaller than trail — adjust to taste
        this.gravity    = 0.0f;
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
                                       ...
                                       RandomSource random) {
            return new LightningSparkParticle(level, x, y, z, spriteSet);
        }
    }
}